...
- New Pagination method ``regularLinks()`` creates complete pagination links where Next/Previous links to the pages before/after the current page, instead of next/previous groups of links.
